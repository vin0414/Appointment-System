    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="sidebar-menu">
            ...
            <ul class="navbar-nav pt-lg-3">
                ...
                <li class="nav-item <?= ($title=="Ranks") ? 'active' :'' ?>">
                    <a class="nav-link" href="{{ route('ranks') }}">
                        ...
                        <span class="nav-link-title"> Teaching Ranks </span>
                    </a>
                </li>
                <li class="nav-item {{ request()->routeIs('career-advancement/upload') ? 'active' : '' }}">
                    <a class="nav-link" href="{{ route('career-advancement/upload') }}">
                        <span class="nav-link-icon d-md-none d-lg-inline-block">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round"
                        ...
                        <span class="nav-link-title"> Upload IPCRF </span>
                    </a>
                </li>
                ...
                <li class="nav-item mt-3">
                    <h6 class="ps-4 text-uppercase text-xs font-weight-bolder opacity-6">Maintenance</h6>
                </li>
                <li class="nav-item <?= ($title=="Maintenance") ? 'active' :'' ?>">
                    <a class="nav-link" href="{{ route('maintenance/settings') }}">
                        <span class="nav-link-icon d-md-none d-lg-inline-block">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round"
